...
import { ArrowRight, Shield, Lock, Eye, Database, Bell, Mail } from "lucide-react";
...
const sections = [
  ...
  },
  {
    ...
    content: [
      ...
      "نستخدم Firebase من Google لتخزين البيانات بشكل آمن.",
      "يمكنك طلب حذف حسابك وجميع بياناتك في أي وقت من إعدادات التطبيق.",
    ],
  },
  {
    icon: Bell,

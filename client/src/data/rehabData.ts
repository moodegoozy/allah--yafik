 ...
 * "الله يعافيك" - مبني على أحدث البروتوكولات الوقائية العلمية
...
export const motivationalQuotes = [
  ...
  { text: "الله يعافيك — ويحفظك ويقيك من كل شر", author: "دعاء" },
  { text: "كل يوم تختار الوقاية هو انتصار يستحق الاحتفال", author: "برنامج الله يعافيك" },
